...
> CECS 326 · Section 03 · Fall 2026

The structure and functions of operating systems — interrupt handling, processes and interprocess communication, memory management, resource scheduling, information sharing and protection, with project implementation in C/C++.
...
| **Section** | 03 (Class Number 10674) |
| **Term** | Fall 2026 · August 24 – December 11, 2026 |
| **Meets** | Tue / Thu · 3:30 – 4:45 PM |
| **Room** | DESN-112 |
| **Exam 3** | Tuesday, December 15 · 2:45 – 4:45 PM *(University final-exam slot)* |
...
**Prerequisites:** CECS 282 and 285 (or 346).

The structure and functions of operating systems. Interrupt handling, processes and interprocess communication, memory management, resource scheduling, information sharing and protection. Project implementation in C/C++. (Lecture 2 hours, laboratory 3 hours.) Letter grade only (A–F).
...
> [!IMPORTANT]
> **Read the [Discussion Forum Rules](https://github.com/agiacalone/cecs-326-fa26-03-syllabus-10674/blob/main/docs/discussion-rules.md) before your first post.** They define what earns credit, what does not, the conduct expectations, and how the AI and academic-honesty policies apply in the forum. They are part of this syllabus.
...
| Week of | Subject |
|------|---------|
| **Aug 24** | Introduction to Operating Systems |
| **Aug 31** | Processes and Threads |
| **Sep  7** | Processes and Threads, ctd |
| **Sep 14** | 🅰 **Exam 1** · Memory Management |
| **Sep 21** | Memory Management, ctd |
| **Sep 28** | Deadlock |
| **Oct  5** | Deadlock, ctd |
| **Oct 12** | I/O |
| **Oct 19** | I/O, ctd |
| **Oct 26** | 🅱 **Exam 2** |
| **Nov  2** | File Systems |
| **Nov  9** | File Systems, ctd |
| **Nov 16** | Virtualization |
| **Nov 23** | Virtualization, ctd — ⚠ **Thanksgiving: no Thursday class** |
| **Nov 30** | Case Studies |
...
- **Participation in the online discussion forum on Canvas is required, not optional.** It is worth **10% of your grade**, and you are expected to follow the [Discussion Forum Rules](https://github.com/agiacalone/cecs-326-fa26-03-syllabus-10674/blob/main/docs/discussion-rules.md). Read them before posting. Posting nothing forfeits that 10% outright: there is no alternative assignment and no way to make it up at the end of the semester.
...
>
> A forum full of confident, agreeable, generic text is not worth reading, and if nobody reads it the 10% is a tax we all pay for nothing. That is the real problem. Details in the [Discussion Forum Rules](https://github.com/agiacalone/cecs-326-fa26-03-syllabus-10674/blob/main/docs/discussion-rules.md).
>
